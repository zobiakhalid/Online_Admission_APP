...
public class EducationalIFragment extends Fragment {
    Button Next,uf;
    public EducationalIFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_educational_i, container, false);
